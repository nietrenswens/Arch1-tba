...
def gebruik(item):
 ...
 In plaats van te zweven donder je als een steen van de berg af en stierf je een pijnlijke dood.")
            ...
            if location.getName() == "bostop":
                ...
                location.setDescription("De walvis ligt er nog... Je voelt je er niet heel goed bij en kijkt weg. Richting het westen zie je een pad dat omhoog loopt. Richting het zuiden zie je een pad het bos in leidt. Richting het oosten zie je de bomen minderen en lijk je een huisje te zien.") #leuk extra tekstje als ie terugkomt
                inventory.remove(item)
            ...
            if location.getName() == "dehethek":
                ...
                location.setDescription("Je ziet een open hek, achter het hek scheiden de wegen. Richting het oosten zie je het pad dichter het bos in lopen. Richting het westen lijk je een klif te zien. Richting het noorden zie je meer bos.")
                inventory.remove(item)
                removeCommand("gebruik " + item.getName())
                removeCommand("onderzoek " + item.getName())
            else:
...
def pak(itemname):
    ...
    if item is not None:
        ...
        if item.getName() == "sleutel":
            item.setDescription("Een bronzen sleutel. De sleutel ziet er glimmend uit met een klein laagje bloed erop.")
